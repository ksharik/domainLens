...
findings and preserves links to evidence, classification, review state, and
revision history. Generated prose and diagrams are views of the model, not the
...
- Persistence must support stable identities, provenance, relationships,
  versions, and human decisions.
